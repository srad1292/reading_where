...
class SeedData {
  ...
  static List<Country> getCountryData() {
    return [
      ...
      Country(code: "by", name: "Belarus", region: "Europe"),
      ...
      Country(code: "br", name: "Brazil", region: "South America"),
      ...
      Country(code: "gb-sct", name: "Scotland", region: "Europe"),
  ...
  static List<CountryState> getCountryStateData() {
    return [
      CountryState(code: 'al', name: 'Alabama', countryCode: 'us'),
      CountryState(code: 'ak', name: 'Alaska', countryCode: 'us'),
      CountryState(code: 'az', name: 'Arizona', countryCode: 'us'),
      CountryState(code: 'ar', name: 'Arkansas', countryCode: 'us'),
      CountryState(code: 'ca', name: 'California', countryCode: 'us'),
      CountryState(code: 'co', name: 'Colorado', countryCode: 'us'),
      CountryState(code: 'ct', name: 'Connecticut', countryCode: 'us'),
      CountryState(code: 'de', name: 'Delaware', countryCode: 'us'),
      CountryState(code: 'fl', name: 'Florida', countryCode: 'us'),
      CountryState(code: 'ga', name: 'Georgia', countryCode: 'us'),
      CountryState(code: 'hi', name: 'Hawaii', countryCode: 'us'),
      CountryState(code: 'id', name: 'Idaho', countryCode: 'us'),
      CountryState(code: 'il', name: 'Illinois', countryCode: 'us'),
      CountryState(code: 'in', name: 'Indiana', countryCode: 'us'),
      CountryState(code: 'ia', name: 'Iowa', countryCode: 'us'),
      CountryState(code: 'ks', name: 'Kansas', countryCode: 'us'),
      CountryState(code: 'ky', name: 'Kentucky', countryCode: 'us'),
      CountryState(code: 'la', name: 'Louisiana', countryCode: 'us'),
      CountryState(code: 'me', name: 'Maine', countryCode: 'us'),
      CountryState(code: 'md', name: 'Maryland', countryCode: 'us'),
      CountryState(code: 'ma', name: 'Massachusetts', countryCode: 'us'),
      CountryState(code: 'mi', name: 'Michigan', countryCode: 'us'),
      CountryState(code: 'mn', name: 'Minnesota', countryCode: 'us'),
      CountryState(code: 'ms', name: 'Mississippi', countryCode: 'us'),
      CountryState(code: 'mo', name: 'Missouri', countryCode: 'us'),
      CountryState(code: 'mt', name: 'Montana', countryCode: 'us'),
      CountryState(code: 'ne', name: 'Nebraska', countryCode: 'us'),
      CountryState(code: 'nv', name: 'Nevada', countryCode: 'us'),
      CountryState(code: 'nh', name: 'New Hampshire', countryCode: 'us'),
      CountryState(code: 'nj', name: 'New Jersey', countryCode: 'us'),
      CountryState(code: 'nm', name: 'New Mexico', countryCode: 'us'),
      CountryState(code: 'ny', name: 'New York', countryCode: 'us'),
      CountryState(code: 'nc', name: 'North Carolina', countryCode: 'us'),
      CountryState(code: 'nd', name: 'North Dakota', countryCode: 'us'),
      CountryState(code: 'oh', name: 'Ohio', countryCode: 'us'),
      CountryState(code: 'ok', name: 'Oklahoma', countryCode: 'us'),
      CountryState(code: 'or', name: 'Oregon', countryCode: 'us'),
      CountryState(code: 'pa', name: 'Pennsylvania', countryCode: 'us'),
      CountryState(code: 'ri', name: 'Rhode Island', countryCode: 'us'),
      CountryState(code: 'sc', name: 'South Carolina', countryCode: 'us'),
      CountryState(code: 'sd', name: 'South Dakota', countryCode: 'us'),
      CountryState(code: 'tn', name: 'Tennessee', countryCode: 'us'),
      CountryState(code: 'tx', name: 'Texas', countryCode: 'us'),
      CountryState(code: 'ut', name: 'Utah', countryCode: 'us'),
      CountryState(code: 'vt', name: 'Vermont', countryCode: 'us'),
      CountryState(code: 'va', name: 'Virginia', countryCode: 'us'),
      CountryState(code: 'wa', name: 'Washington', countryCode: 'us'),
      CountryState(code: 'wv', name: 'West Virginia', countryCode: 'us'),
      CountryState(code: 'wi', name: 'Wisconsin', countryCode: 'us'),
      CountryState(code: 'wy', name: 'Wyoming', countryCode: 'us'),
    ];
  }
}